 ...
 */
CultureidGlobalLocalisationLogger::CultureidGlobalLocalisationLogger(void) :
                       ...
                       num_ground_truths_(0)
{
  ...
  execution_time_sub_ = nodehandle_.subscribe(execution_time_topic_, 10,
    &CultureidGlobalLocalisationLogger::executionTimeCallback, this);

  map_sub_ = nodehandle_.subscribe(map_topic_, 1,
    &CultureidGlobalLocalisationLogger::mapCallback, this);

  num_particles_sub_ = nodehandle_.subscribe(num_particles_topic_, 1,
    &CultureidGlobalLocalisationLogger::numParticlesCallback, this);

  image_size_sub_ = nodehandle_.subscribe(image_size_topic_, 1,
    &CultureidGlobalLocalisationLogger::imageSizeCallback, this);

  image_format_sub_ = nodehandle_.subscribe(image_format_topic_, 1,
    &CultureidGlobalLocalisationLogger::imageFormatCallback, this);

  initLogfiles();

  sleep(20);

  //callCultureidGlobalLocalisation();

  ROS_INFO("[CultureidGlobalLocalisationLogger] Node initialised");
}
...
CultureidGlobalLocalisationLogger::~CultureidGlobalLocalisationLogger(void)
{
  ROS_INFO("[CultureidGlobalLocalisationLogger] Node destroyed");
}
 ...
 * Logs execution time
 */
void CultureidGlobalLocalisationLogger::executionTimeCallback(const std_msgs::Duration& msg)
{
  ...
  if (file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] Could not log execution time");
}


/*******************************************************************************
 * Logs the ground truth pose of the robot.
void CultureidGlobalLocalisationLogger::groundTruthCallback(const nav_msgs::Odometry& msg)
{
  num_ground_truths_++;
 ...
 */
void CultureidGlobalLocalisationLogger::imageFormatCallback(
 ...
 */
void CultureidGlobalLocalisationLogger::imageSizeCallback(
 ...
 */
void CultureidGlobalLocalisationLogger::initLogfiles(void)
{
  //----------------------------------------------------------------------------
  ...
  if (ground_truth_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] Ground truth file not open");
  ...
  if (global_pose_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] global pose file not open");
  ...
  if (execution_time_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] execution-time file not open");
  ...
  if (map_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] Map file not open");
  ...
  if (num_particles_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] number of particles file not open");
  ...
  if (image_size_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] image size file not open");
  ...
  if (image_format_file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] image format file not open");
}
 ...
 */
void CultureidGlobalLocalisationLogger::loadParams(void)
{
  //----------------------------------------------------------------------------
  // Get topic names
 ...
 * Logs a pose
 */
void CultureidGlobalLocalisationLogger::logPose(
  ...
  const std::string& filename)
{
  ...
  if (file.is_open())
  {
    ...
    ROS_ERROR("[CultureidGlobalLocalisationLogger] Could not log pose");
}

/*******************************************************************************
 * Logs the map
 */
void CultureidGlobalLocalisationLogger::mapCallback(
 ...
 */
void CultureidGlobalLocalisationLogger::numParticlesCallback(
  const std_msgs::UInt64& msg)
{
 ...
 */
void CultureidGlobalLocalisationLogger::callCultureidGlobalLocalisation()
{
  ...
  std_srvs::Empty srv;
  if (client.call(srv))
    ROS_INFO("[CultureidGlobalLocalisationLogger] Successful call to fmt global localisation");
  else
  {
    ROS_ERROR("[CultureidGlobalLocalisationLogger] Failed to call fmt global localisation");
    return;
  }
}
