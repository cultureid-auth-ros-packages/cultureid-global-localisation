#ifndef Cultureid_GLOBAL_LOCALISATION_LOGGER_H
#define Cultureid_GLOBAL_LOCALISATION_LOGGER_H
...
class CultureidGlobalLocalisationLogger
{
  private:
    ...
    void callCultureidGlobalLocalisation();


  public:
    CultureidGlobalLocalisationLogger(void);
    ~CultureidGlobalLocalisationLogger(void);
...
#endif // Cultureid_GLOBAL_LOCALISATION_LOGGER_H
